...
function sum(add){
    return add.reduce(function(accumulator, element){return accumulator+element;},0);
...
function multiply(mult){
    return mult.reduce(function(product, elem){return product*elem;},1);
...
function findLongestWord(word){
    let longestword=word.reduce(function(longest, current){
